...
public class RegisterTest {
    ...
    public void registerTest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.emailRegister), withText("e"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.passwordConfRegister),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.passwordConfRegister), withText("e"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.nameRegister),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.passwordRegister),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("e"), closeSoftKeyboard());

        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.passwordRegister), withText("e"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.nameRegister), withText("e"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
