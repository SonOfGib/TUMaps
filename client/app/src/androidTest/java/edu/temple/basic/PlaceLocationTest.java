...
public class PlaceLocationTest {
    ...
    public void placeLocationTest() {
        ...
        ViewInteraction appCompatButton3 = onView(
                allOf(withId(android.R.id.button1), withText("Current Location"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.buttonPanel),
                                        0),
        ...
        ViewInteraction editText2 = onView(
                allOf(childAtPosition(
                        ...
                        0),
                        isDisplayed()));
        editText2.perform(replaceText("1940"), closeSoftKeyboard());
