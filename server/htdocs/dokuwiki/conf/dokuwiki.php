...
$conf['authtype']    = 'authpdo';      //which authentication backend should be used
$conf['passcrypt']   = 'bcrypt';           //Used crypt method (smd5,md5,sha1,ssha,crypt,mysql,my411)
...
$conf['remoteuser']  = '';    //user/groups that have access to remote interface (comma separated)
